...
class EntityTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testSetVariables() {
        ...
        $expectedValues = [
            ...
            "price" => 100.5,
            "quantity" => 3,
            "registered_at" => "2015-02-14T00:00:00+00:00",
            "object" => $object,
            "other" => 'other',
    ...
    public function testAll() {
        $hub = new FakeApiHub();
        $request = $this->getMockBuilder('PagosPyme\Http\CurlRequest')->getMock();
        ...
        Entity::setManager($manager);
        $this->_entity = new DummyEntity();
        $this->assertEquals('PagosPyme\DummyEntity', get_class($this->_entity->All()[0]));
    }
